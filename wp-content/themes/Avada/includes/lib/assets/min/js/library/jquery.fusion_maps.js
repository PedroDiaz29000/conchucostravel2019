! function(a, b, c, d) {
	...
	a.extend(e.prototype, {
		...
		create_infowindow: function(a, b) {
			...
			}, e.className = "fusion-info-box", e.style.cssText = "background-color:" + this.settings.infobox_background_color + ";color:" + this.settings.infobox_text_color + ";", e.innerHTML = a, d = new InfoBox(f), this.settings.show_address && d.open(this.map, b), google.maps.event.addListener(b, "click", function() {
				var a = d.getMap();
