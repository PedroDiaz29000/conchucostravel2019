! function(a, b) {
	...
	return b.contains = function(a) {
		...
		return f < j && (c = new a({
			...
			width: g,
			height: j - f
		}), d.push(c)), m > o && (c = new a({
			x: o,
			y: f,
			width: m - o,
			height: h
		}), d.push(c)), n > p && (c = new a({
			x: e,
			y: p,
			width: g,
			height: n - p
		}), d.push(c)), e < i && (c = new a({
			x: e,
			y: f,
			width: i - e,
			height: h
	...
	c.reset = function() {
		...
		if ("object" == typeof b) {
			...
			b.forEach(function(a) {
				if (1 < a.width) {
					var b = a.y + 1,
						c = a.y - 1; - 1 !== jQuery.inArray(b, g) && (a.y = b), -1 !== jQuery.inArray(c, g) && (a.y = c), g.push(a.y), f.push(a)
				}
			}), b = f
		}
...
function(a, b) {
	...
	c.prototype.canFit = function(a) {
		return this.width >= a.width - 2 && this.height >= a.height - 2
	};
	...
	j._create = function() {
		...
		window.currentPackeryElement = b;
		var d = a(b),
			e = d.outerWidth,
			f = d.outerHeight;
