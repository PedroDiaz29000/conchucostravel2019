...
jQuery(document).ready(function() {
    ...
    jQuery(document).on("bleeper_new_message", function(e) {
         ...
         */
        Cookies.set('bleeper_received_msg', true, {
            expires: 1,
            path: '/'
        });
        if (typeof e.ndata === "object") {
            if (typeof e.ndata.message === "undefined") {
                e.ndata.message = '';
            }
            the_message = {};
            the_message.other = {};
        ...
        if (typeof e.ndata !== "undefined") {
            if (typeof e.ndata.action !== "undefined") {
                if (e.ndata.action === "send_custom_header") {
                    ...
                    var ta_bio = '';
                    var ta_social_links = '';
                    if (typeof e.ndata.ndata.email !== "undefined") {
                        temail = e.ndata.ndata.email;
                    }
                    if (typeof e.ndata.ndata.name !== "undefined") {
                        tname = e.ndata.ndata.name;
                    }
                    if (typeof e.ndata.ndata.aid !== "undefined") {
                        taid = e.ndata.ndata.aid;
                    }
                    if (typeof e.ndata.ndata.tagline !== "undefined") {
                        ta_tagline = e.ndata.ndata.tagline;
                    }
                    if (typeof e.ndata.ndata.bio !== "undefined") {
                        ta_bio = e.ndata.ndata.bio;
                    }
                    if (typeof e.ndata.ndata.social !== "undefined") {
                        ta_social_links = e.ndata.ndata.social;
                    }
                    var data = {
    ...
    jQuery(document).on("nifty_trigger_start_chat", function(e) {
        ...
        if (typeof wplc_cookie_name == 'undefined') {
            var wplc_cookie_name = jQuery("#wp-live-chat").find("#wplc_name").val();
        }
        if (typeof wplc_cookie_email == 'undefined') {
            var wplc_cookie_email = jQuery("#wp-live-chat").find("#wplc_email").val();
        }
    ...
    if (typeof wplc_elem_trigger_id !== "undefined" && wplc_elem_trigger_id !== "") {
        ...
        if (typeof wplc_elem_trigger_action !== "undefined" && wplc_elem_trigger_action !== "") {
            wplc_click_or_hover = parseInt(wplc_elem_trigger_action);
        }
        if (typeof wplc_elem_trigger_type !== "undefined" && wplc_elem_trigger_type !== "") {
            wplc_class_or_id = parseInt(wplc_elem_trigger_type);
        }
        try {
    ...
    jQuery(document).on("wplc_end_chat_as_user", function(e) {
        ...
        if (typeof io !== "undefined") {
            socket = io.connect(NIFTY_SOCKET_URI, {
                query: query_string,
